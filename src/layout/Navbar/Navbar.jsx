                ...
                {notifications.length > 0 ? (
                  <>
                    {notifications.map((noti, i) => (
                      <li
                        key={i}
                        className={`flex cursor-pointer border-b py-2 hover:bg-primary duration-150 group px-5 flex-col w-full items-start justify-center ${noti.status==='unread'?"bg-blue-100":"bg-baase-100"}`}>
